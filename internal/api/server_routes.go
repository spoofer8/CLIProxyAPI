...
func (s *Server) setupRoutes() {
	...
	v1.Use(AuthMiddleware(s.accessManager), s.userManagementMiddleware())
	{
		v1.GET("/models", s.userManagementModelsMiddleware(), s.unifiedModelsHandler(openaiHandlers, claudeCodeHandlers))
	...
	openaiV1.Use(AuthMiddleware(s.accessManager), s.userManagementMiddleware())
	{
	...
	codexDirect.Use(AuthMiddleware(s.accessManager), s.userManagementMiddleware())
	{
	...
	v1beta.Use(AuthMiddleware(s.accessManager), s.userManagementMiddleware())
	{
		v1beta.GET("/models", s.userManagementModelsMiddleware(), s.geminiModelsHandler(geminiHandlers))
		v1beta.POST("/interactions", geminiHandlers.Interactions)
		v1beta.POST("/models/*action", geminiHandlers.GeminiHandler)
		v1beta.GET("/models/*action", s.userManagementModelsMiddleware(), s.geminiGetHandler(geminiHandlers))
	}
